      ...
      {{-- Home Image --}}
        ...
        {{-- Image Text --}}
            <div class="mainTextPosition text-center">
              <h5 class="mainTextSize">Explore Lombok & Komodo at Your Own Pace</h5>
              <p>Where Every Road Becomes Your Story</p>
            </div>

        
        <pre class="text-center fs-3 mt-3">Wellcome To Dilaga Tour & Travel 🙏</pre>
        ...
        <div class="container mt-5">
             <div class="d-flex justify-content-between">
                <div>
                    ...
                    <pre>Explore Dilaga Trour Gems in a Day</pre>
                </div>
                <div>
        ...
        <div class="container-fluid mt-5 section-bg-color-home">
            <div class="row ">
                <div class="col m-5">
                    ...
                    <h2>Discover the Dilaga Tour Tours Difference</h2>
                    <p>At Dilaga Tours Travels, we go beyond being just a travel agency; 
                        we're your gateway to an extraordinary Dilaga Tours experience. Here's why choosing us will redefine your journey
                    </p>
                    ...
                    <ol>
                        <li>
                            <div class="alignment">
                                <h5>Lombok & Komodo: Your Gateway to Island Adventures</h5>
                                <p>
                                    At Dilaga Tours Travels, we go beyond being just a travel agency;<br>
                                    we're your gateway to an extraordinary Dilaga Tours experience.<br>
                                    Here's why choosing us will redefine your journey.
                                </p>
                        ...
                        <li>
                            <div class="alignment">
                                ...
                                <p>Immerse yourself in Dilaga Tours culture. Meet locals, savor authentic cuisine, and <br/>
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="col-7 review-bg p-4 text-justify">
                            ...
                            <q class="font-monospace">Booking a tour with Ceylonia Travels was the best decision I made for my Dilaga Tour adventure. 
                      ...
                      <div class="carousel-item">
                        <div class="col-7 review-bg p-4 text-justify">
                            ...
                            <hr/>
                            <p class="font-monospace">Amal <br/> Dilaga Tour </p>
                        </div>
                      </div>
                    </div>
